...
export default function Hero() {
  ...
  return (
    <section id="home" className="pt-20 pb-16 bg-gradient-to-br from-[var(--primary-light)] to-blue-50">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative bg-white rounded-2xl shadow-2xl p-8">
              ...
              />
              <div className="absolute -top-4 -right-4 bg-[var(--primary-color)] text-white p-3 rounded-full">
