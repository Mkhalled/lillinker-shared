          ...
          <div className="flex justify-between items-start">
            <div className="flex-1">
              ...
              {service.user?.ownedCompany && (
                <p className="text-xs text-gray-500 mt-1">Par {service.user.ownedCompany.name}</p>
              )}
            </div>
            <div className="ml-3">
              <StyledCheckbox
          ...
          <div>
            ...
            {formData.newServices.length > 0 && (
              <p className="text-sm text-gray-600 mt-1">
                ...
                créé{formData.newServices.length > 1 ? 's' : ''}
              </p>
            )}
          </div>
          <Button
        ...
        {formData.newServices.length > 0 && (
          <div className="space-y-3">
            ...
            <div className="pt-2">
              ...
              >
                Tout supprimer ({formData.newServices.length} service
                {formData.newServices.length > 1 ? 's' : ''})
              </button>
            </div>
          </div>
        )}
