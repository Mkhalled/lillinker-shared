...
const MesReponses = ({ demandeData, pagination = { currentPage: 1, pageSize: 10, totalPages: 1 }, onPageChange }: MesReponsesProps) => {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="flex justify-between items-center px-5 pt-6 pb-2 sm:px-7.5">
        <h4 className="text-xl font-semibold text-black dark:text-white">Mes Reponses</h4>
        <button
