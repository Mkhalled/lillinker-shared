...
import { BarChart3, BriefcaseIcon, CheckCircle, Clock, FileIcon, LineChart, UserPlus, XCircle } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-5 border border-slate-200 dark:border-slate-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mt-1">{dashboardStats.totalResponses}</h3>
            </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-5 border border-slate-200 dark:border-slate-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Accepted Responses</p>
              <h3 className="text-2xl font-bold text-emerald-600 dark:text-emerald-400 mt-1">{dashboardStats.acceptedResponses}</h3>
            </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-5 border border-slate-200 dark:border-slate-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Declined Responses</p>
              <h3 className="text-2xl font-bold text-rose-600 dark:text-rose-400 mt-1">{dashboardStats.declinedResponses}</h3>
            </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-5 border border-slate-200 dark:border-slate-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Pending Responses</p>
              <h3 className="text-2xl font-bold text-amber-600 dark:text-amber-400 mt-1">{dashboardStats.pendingResponses}</h3>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-slate-800 rounded-xl shadow-md border border-slate-200 dark:border-slate-700 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
            ...
            <Link href="/company/admin/activity" 
              ...
              <li key={activity.id} className="px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                <div className="flex items-center space-x-4">
                  <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center 
                    ${activity.status === 'accepted' ? 'bg-emerald-100 dark:bg-emerald-900/30' : 
                      activity.status === 'declined' ? 'bg-rose-100 dark:bg-rose-900/30' : 
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 truncate">
                      {activity.type === 'response' ? 'Awaiting response on' : 
                       activity.type === 'accepted' ? 'Accepted your offer for' :
                       'Declined your offer for'} <span className="font-medium">{activity.serviceName}</span>
                    </p>
                  </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md border border-slate-200 dark:border-slate-700 overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            <Link href="/company/admin/services" 
              ...
              <div className="ml-4">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">Update your service offerings</p>
              </div>
            </Link>
            <Link href="/company/admin/freelancers" 
              className="flex items-center p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
              <div className="flex-shrink-0 bg-emerald-100 dark:bg-emerald-900/30 p-2 rounded-md">
                <UserPlus className="h-5 w-5 text-emerald-600 dark:text-emerald-400" />
              </div>
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-900 dark:text-white">View Freelancers</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Browse freelancer profiles</p>
              </div>
            </Link>
            <Link href="/company/admin/invoices" 
              className="flex items-center p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
              ...
              <div className="ml-4">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">Manage billing and payments</p>
              </div>
            </Link>
            <Link href="/company/admin/reports" 
              className="flex items-center p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
